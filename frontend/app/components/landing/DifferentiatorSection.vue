<template>
  <section id="diferencia" class="bg-ink-900 py-16 text-white md:py-24">
    <div class="mx-auto max-w-[1200px] px-6">
      <LandingRevealOnScroll>
        <h2 class="font-display text-3xl font-bold">No es un bot que se une a tu reunión de Zoom.</h2>
